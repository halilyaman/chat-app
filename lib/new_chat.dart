      ...
      body: Column(
        children: [
          ...
          searchResults.length != 0
              ...
              : Container(),
          searchResults.length != 0 ? Divider(color: Colors.black,) : Container(),
          searchResults.length != 0
              ? Expanded(
                  flex: 1,
                  child: ListView(
                            ...
                            child: Center(
                              child: ListTile(
                                leading: CircleAvatar(
                                  backgroundImage:
                                      NetworkImage(doc["contactPhotoUrl"]),
                                ),
                                ...
                                onTap: () async {
                                  ...
                                  Navigator.push(context, MaterialPageRoute(
                                    builder: (context) => ChatPage(
                                      chatId: chatId,
                                      peerId: peerId,
                                      photoUrl: doc["contactPhotoUrl"],
                                      nickname: doc["contactNickname"],
                                      prefs: widget.prefs,
                                    )
                                  ));
                                },
  ...
  searchUsers() async {
    ...
    for (int i = 0; i < userDocs.length; i++) {
      ...
      final QuerySnapshot contactResults = await Firestore.instance
          .collection("users").document(widget.prefs.get("id")).collection("contacts")
